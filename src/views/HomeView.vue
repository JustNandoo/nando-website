<template>
  <main
    class="md:mt-1 flex flex-col-reverse gap-8 items-center md:flex-row md:gap-16 md:justify-center min-h-[65vh] md:min-h-[80vh]">
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-amber-200">Engineering the Future, I'm</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Acaryanandana Alif Fajar</h1>
      <div class="py-2">
        <h1
      ...
      <br>
      <a href="/CV_ACARYANANDANA_ALIF_FAJAR.pdf" download="CV_Acaryanandana_Alif_Fajar.pdf"
    ...
    <div class="flex justify-center md:justify-start fadein-right">
      <img alt="avatar" fetchpriority="high" width="550" height="550" decoding="async" data-nimg="1"
           class="w-64 h-64 md:w-96 md:h-96 rounded-full border-4 border-amber-500 object-cover aspect-square"
...
export default {
  ...
  data() {
    return {
      toRotate: ["Mobile Developer", "Web Developer", "Science Data", "Software Engineer"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
