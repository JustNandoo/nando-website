    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 3,
          name: 'Flutter',
          imageUrl: 'https://cdn.iconscout.com/icon/free/png-256/free-flutter-2038877-1720090.png',
          status: 'Advanced'
        },
        {
          id: 4,
          name: 'JavaScript',
          imageUrl: 'https://cdn.iconscout.com/icon/free/png-256/free-javascript-1-225993.png',
          status: 'Intermediate'
        },
        {
          id: 5,
      ...
      tools: [
        ...
        },
        {
          id: 3,
          name: 'Figma',
          imageUrl: 'https://cdn.iconscout.com/icon/free/png-256/free-figma-3521426-2944870.png',
          status: 'UI/UX Design'
        },
      ]
    };
      ...
      <section
        ...
        <div class="flex justify-center md:justify-start fadein-right">
          <img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
               class="w-58 58 md:w-96 md:h-92 rounded-full border-4 border-amber-500 object-cover aspect-square"
               src="../images/nando-esport.jpg">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hello, and welcome! My name is Acaryanandana Alif Fajar, a passionate Software Developer from Bekasi, West Java, Indonesia. Specializing in mobile app development.
            I love bringing ideas to life through innovative and user-friendly applications, exploring my creativity, solving complex problems, and crafting
            meaningful digital experiences. Being a developer allows me to push the boundaries of technology and create solutions that make an impact.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; Currently, I am 18 years old and studying at SMK Raden Umar Said Kudus. Despite still being in school, I have gained professional experience through an internship at PT. Elcarim Optronic Indonesia as a Mobile App Developer.
            This experience has provided me with valuable insights into the industry, strengthened my technical skills, and enhanced my ability to develop efficient and innovative applications.
            I am always eager to learn, grow, and contribute to the world of technology. If you are interested in hiring me,
